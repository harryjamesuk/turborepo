...
func (o *Opts) ResolveCacheDir(repoRoot fs.AbsolutePath) fs.AbsolutePath {
	if o.OverrideDir != "" {
...
func New(opts Opts, repoRoot fs.AbsolutePath, client client, recorder analytics.Recorder, onCacheRemoved OnCacheRemoved) (Cache, error) {
...
func newSyncCache(opts Opts, repoRoot fs.AbsolutePath, client client, recorder analytics.Recorder, onCacheRemoved OnCacheRemoved) (Cache, error) {
